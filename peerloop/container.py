...
from peerloop.config import load_config
from peerloop.core.authentication.token_manager import TokenManager
from peerloop.core.db.session_maker import get_session_context
from peerloop.core.email.email_manager import EmailManager
from peerloop.core.middlewares.sqlalchemy import SQLAlchemyMiddleware
from peerloop.domain.auth.container import AuthContainer
from peerloop.domain.user.container import UserContainer


class AppContainer(containers.DeclarativeContainer):
    # Wire the source package
    wiring_config = containers.WiringConfiguration(packages=["peerloop"], modules=[__name__])
